...
public class ServerDemo03 {
    public static void main(String[] args) throws InterruptedException, KeeperException {
        ...
        zooKeeper.create("/servers/ServerDemo03", "ServerDemo03".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL);
        System.out.println("ServerDemo03 上线了");
        // 3. 业务处理逻辑
